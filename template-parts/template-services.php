...
<div id="primary" class="content-area">
  <main id="main" class="site-main">
    ...
    <div class="content-block pt-5">
      ...
      <section class="common-section services-section pt-0">
        <div class="container">
                  ...
                  <div class="widget custom-widget-subpages">
                    ...
                    <ul class="child-list">
                      <div class="parent-page">
                        <li><a href="<?php echo site_url(); ?>/services/"> Management Consultancy </a></li>
                        <li><a href="<?php echo site_url(); ?>/services/"> Certifications and Compliances </a></li>
                        <li><a href="<?php echo site_url(); ?>/services/"> Licensing, Compliances & Laisioning </a></li>
                        <li><a href="<?php echo site_url(); ?>/services/"> FEMA and WHO Nations Compliances </a></li>
                        <li><a href="<?php echo site_url(); ?>/services/"> IPO for Companies and Compliances </a></li>
                        <li><a href="<?php echo site_url(); ?>/services/"> Risk management and Insurance </a></li>
                      </div>
                    </ul>
                  </div>
