      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            ...
            <div class="social-menu text-center text-md-left">
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div class="footer-text pr-md-5">
              <p>llinois Solar Garden empowers homeowners to harness the limitless power of the sun and shape a sustainable energy future for all of Illinois. </p>
            </div>
          </div>
          ...
          <!-- <div class="col-lg-4 col-md-12">
            ...
            <div class="newsletter-form">
              <?php // echo do_shortcode('[contact-form-7 id="50" title="Newsletter form"]'); ?>
            </div>
          </div> -->
